...
public class ControladorCategoria {
    ...
    public String listarCategorias() {
        System.out.println(" C : Ejecutando consulta LISCAT...");
        List<Categoria> categorias = categoriaDAO.listarCategorias();
        return formatearResultado("ROLES", categorias);
    }
    
    public String insertarCategoria(String parametros) {
        System.out.println(" C : Ejecutando comando INSCAT...");
        List<String> parts = extraerParametros(parametros);
        if (parts == null) return " C: Formato inválido en INSCAT.";
        ...
        try {
            ...
            categoriaDAO.insertarCategoria(p);
            return " C: Categoria creado exitosamente.";
    ...
    public String editarCategoria(String parametros) {
        System.out.println(" C : Ejecutando comando EDICAT...");
        List<String> parts = extraerParametros(parametros);
        if (parts == null) return " C: Formato inválido en EDICAT.";

        // Esperamos: id, nombre
        if (parts.size() != 2) {
            return " C: EDICAT espera 2 parámetros: id, nombre";
        }
        ...
        try {
            ...
            categoriaDAO.editarCategoria(p);
            return " C: Categoria editado exitosamente.";
    ...
    public String eliminarCategoria(String parametros) {
        System.out.println(" C : Ejecutando comando ELICAT...");
        List<String> parts = extraerParametros(parametros);
        if (parts == null) return " C: Formato inválido en ELICAT.";

        // Esperamos: id
        if (parts.size() != 1) {
            return " C: ELICAT espera 1 parámetro: id.";
        }
        ...
        try {
            ...
            e.printStackTrace();
            return " C: Error al eliminar categoria: " + e.getMessage();
        }
    }
    ...
    private String formatearResultado(String titulo, List<Categoria> resultados) {
